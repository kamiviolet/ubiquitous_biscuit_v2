...
const styles = {
    ...
    article_card: "animate-in grid grid-rows-[auto_auto_auto] grid-cols-[40px_auto] md:grid-cols-[40px_auto_max(275px)] gap-2 py-2 px-4 border-b-[1px] border-[--border] last:border-b-0 hover:bg-blue-100",
}
